...
function SearchPlaceField() {
  useEffect(() => {
    const script = document.createElement('script');
      script.src = 'https://maps.googleapis.com/maps/api/js?key=AIzaSyCGzY_Rd_g1PTjtFprxYhNFxHJF0YwAgfU&libraries=places';
  ...
  return (
    <div className="reusables-search-place-field">
